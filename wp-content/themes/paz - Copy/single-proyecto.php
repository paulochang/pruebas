					...
					<div id="project-txt" class="float-left transition-width">
				  	...
				  	<div id="project-slideshow" class="transition-width">	
				  		<div id="image-helper">
					  		...
					  		<img class="next-arrow absolute pointer" src="<?php echo theme_url ( 'img/project/next.png' ); ?>"></img>
					  		<img class="prev-arrow absolute pointer" src="<?php echo theme_url ( 'img/project/previous.png' ); ?>"></img>
				  		</div>
				  	</div>
				  	<div class="clear"></div>
				</div>

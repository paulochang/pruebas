...
<h1 id="links-title" class="margin-center uppercase txt-center border-bottom">&#47;<?php _e ( 'Links', 'c41' ); ?>&#47;</h1>

<div id="links-content" class="margin-center fixed-width txt-center">

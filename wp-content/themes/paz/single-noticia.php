									...
									<div class="single-news-content museo-sans-300">
								  	...
								  	<div id="single-news-navigator" >
										<div class="float-right">
											<?php next_post_link('%link', '<div class="single-news-next orange float-right">>></div> SIGUIENTE NOTICIA <div class="clear"></div>'); ?>
										</div>
										<div class="float-left">
											<?php previous_post_link('%link', '<div class="single-news-prev orange float-left"><<</div>NOTICIA ANTERIOR <div class="clear"></div>'); ?>
										</div>
